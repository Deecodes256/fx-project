...
function forexrendertodo() {
 ...
 <input type="text" name="" id="" placeholder="pnl for this trade" class="input-pnl"  value = "${item.pnl || ''}" >
...
function forexwinrate() {
  ...
  if (rate <= 49 ){alert("You've been losing a lot lately,do you mind taking a moment to reflect on your previous trades?")}
}
